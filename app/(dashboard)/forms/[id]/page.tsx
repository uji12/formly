  ...
  return (
    <>
      ...
      <div className="w-full pt-8 gap-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 container">
        ...
        <StatsCard
          title="Total submisions"
          icon={<FaWpforms className="text-yellow-600" />}
          helperText="All time form submisions"
...
async function SubmisionsTable({ id }: { id: number }) {
  ...
  return (
    <>
      <h1 className="text-2xl font-bold my-4">submisions</h1>
